...
export const RippleButton = React.forwardRef<HTMLButtonElement, RippleButtonProps>(
  (
    ...
    return (
      <button
        className={`relative inline-flex cursor-pointer items-center justify-center overflow-hidden rounded-full px-5 py-3 text-sm font-medium shadow-ambient ${className}`}
        onClick={handleClick}
        ref={ref}
        {...props}
      >
